...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '317145940 247687027 435279973').split()] # Replace with the actual admin ID(s) to add
